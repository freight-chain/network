> NOTE: You can also read it using
...
By burning a portion of tokens, one relinquishes their governance in exchange
...
If the `round` associated with the given id only had ETH on one side, a refund
